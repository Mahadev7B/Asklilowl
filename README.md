...
The server makes no Anthropic, Fal.ai, OpenAI API, stock-photo, analytics, advertising, or TTS calls. Image handoff uses `_meta["openai/fileParams"]`, allowing ChatGPT-managed files to reach the widget.
