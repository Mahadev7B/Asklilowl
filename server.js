  ...
  registerAppTool(
    ...
    "create_diagram_lesson",
    {
      ...
      description:
        ...
        "For image quality failures, first make at most two targeted native retries per affected slide after its initial attempt, preserving good images. Generate only one slide per request. If quality still fails, explain the defect and obtain explicit user agreement before using diagrams; never silently switch or start narration while awaiting consent. This bounded quality path is also permitted, distinct from technical unavailability. " +
